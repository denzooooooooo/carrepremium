...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Ajoutez un nouvel événement sportif ou culturel</p>
        </div>
        ...
        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="country" required value="Côte d'Ivoire"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                </div>
                ...
                <!-- Image principale -->
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Image principale de l'événement</label>
                ...
                <!-- Adresse du lieu -->
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Adresse du lieu</label>
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Type de sport (si applicable)</label>
                    <select name="sport_type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">
                        <option value="">Sélectionner</option>
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700">Mettre en vedette cet événement</span>
                    </label>
                </div>
            </div>
