<?php
/**
 * Script pour mettre à jour automatiquement toutes les migrations
 * Exécuter: php update_migrations.php
 */

$migrationsPath = __DIR__ . '/carre-premium-backend/database/migrations/';

$migrations = [
    'create_airlines_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_event_seat_zones_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_tour_packages_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_favorites_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_currencies_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_chat_messages_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_chatbot_conversations_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_notifications_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_newsletter_subscribers_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_carousels_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_activity_logs_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_user_preferences_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_promo_codes_table.php' => <<<'PHP'
...
PHP,
    ...
    'create_promo_code_usage_table.php' => <<<'PHP'
...
echo "🚀 Mise à jour des migrations Laravel...\n\n";

foreach ($migrations as $filename => $schemaCode) {
    // Trouver le fichier de migration correspondant
    $files = glob($migrationsPath . '*_' . $filename);
    ...
    // Remplacer le contenu de la méthode up()
    $pattern = '/(public function up\(\): void\s*\{)(.*?)(\}\s*\/\*\*)/s';
    $replacement = "$1\n    $schemaCode\n    $3";
    ...
    if ($newContent && $newContent !== $content) {
        ...
        echo "✅ Mis à jour: " . basename($filepath) . "\n";
    } else {
        echo "⚠️  Aucun changement: " . basename($filepath) . "\n";
    }
}

echo "\n✨ Toutes les migrations ont été mises à jour!\n";
echo "📝 Exécutez: cd carre-premium-backend && php artisan migrate\n";
